...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); // получение элементов
  // перебор инпутов
...
var hints = function hints() {
  ...
  function bindHint(triggerSelector, hintSelector) {
    var triggerHint = document.querySelector(triggerSelector),
        hint = document.querySelector(hintSelector),
        frame = document.querySelector("frame"); // Открытие подсказки

    triggerHint.addEventListener('click', function (e) {
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    scroll = calcScroll(); // Открытие модального окна
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        modal.style.display = "block"; // Отмена скролла экрана под модальным окном

        document.body.style.overflow = "hidden"; // Вариант с использованием Bootstrap
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ""; // убираем правый отступ при закрытии окна
  ...
  function calcScroll() {
    //создаем блок
    var div = document.createElement('div'); //устанавливаем ему ширину и высоту

    div.style.width = '50px';
    div.style.height = '50px'; //устанавливаем стиль отображения элемента (всегда есть полоса прокрутки)

    div.style.overflowY = 'scroll'; //скрываем элемент (делаем прозрачным)

    div.style.visibility = 'hidden'; //помещаем на страницу (не важно куда)

    document.body.appendChild(div); //разница между полной шириной блока и шириной с контентом и границей
    // (без полосы прокрутки)
    //т.е. это ширина полосы прокрутки

    var scrollWidth = div.offsetWidth - div.clientWidth; //удаление теперь не нужного элемента
...
var parallax = function parallax() {
  var imageLeft = document.querySelector('.par__left-img'),
      imageRight = document.querySelector('.par__right-img');
  new simple_parallax_js__WEBPACK_IMPORTED_MODULE_0___default.a(imageLeft, {
    orientation: 'right',
    delay: 1.5,
    scale: 1.8,
    overflow: true
  });
  new simple_parallax_js__WEBPACK_IMPORTED_MODULE_0___default.a(imageRight, {
    orientation: 'left',
    delay: 1.5,
    scale: 1.8,
    overflow: true
